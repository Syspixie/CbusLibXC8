...
#define EEPROM_BOOT_FLAG EEPROM_TOP                 // Set to FF to enter bootloader
#define EEPROM_CAN_ID (EEPROM_TOP - 1)              // 7 bit CANID 1 to 127
#define EEPROM_NODE_NUMBER (EEPROM_TOP - 3)         // 16 bit value for node number (2 bytes)
#define EEPROM_FLIM_MODE (EEPROM_TOP - 4)           // Enumerated value for SLiM/FLiM mode
#define EEPROM_VERSION (EEPROM_TOP - 5)             // Indicates if EEPROM needs initialising or upgrading
#define EEPROM_APPLICATION_TOP (EEPROM_TOP - 40)    // Leaving space for AREQ (34 bytes)
